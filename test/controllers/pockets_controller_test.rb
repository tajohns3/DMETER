...
class PocketsControllerTest < ActionController::TestCase
  ...
  test "should create pocket" do
    assert_difference('Pocket.count') do
      post :create, pocket: { agriculture_land: @pocket.agriculture_land, crop_id: @pocket.crop_id, district_id: @pocket.district_id, percent_irr: @pocket.percent_irr, pocket_name: @pocket.pocket_name, state_id: @pocket.state_id, total_pdealer: @pocket.total_pdealer, type_a: @pocket.type_a, type_b: @pocket.type_b, type_c: @pocket.type_c, type_d: @pocket.type_d, user_id: @pocket.user_id }
    end
