...
class BanksControllerTest < ActionController::TestCase
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post :create, bank: { account_number: @bank.account_number, address: @bank.address, branch: @bank.branch, name: @bank.name, phone: @bank.phone }
    end
  ...
  test "should update bank" do
    patch :update, id: @bank, bank: { account_number: @bank.account_number, address: @bank.address, branch: @bank.branch, name: @bank.name, phone: @bank.phone }
    assert_redirected_to bank_path(assigns(:bank))
  end
