class DealersController < ApplicationController
  ...
  private
    ...
    def dealer_params
      params.require(:dealer).permit(:state_id, :user_id, :pocket_id, :name, :address, :atpost, :pin_code, :taluka_id, :district_id,
                                     banks_attributes: [:id, :name, :branch, :account_number, :address, :phone, :_destroy])
    end
end
