class MeetFarmersController < ApplicationController
  ...
  private
    ...
    def meet_farmer_params
      params.require(:meet_farmer).permit(:fa_activity_id, :farmer_id,:dealer_id,:pocket_dat_id,:number_farmer, :purpose, :consultation, product_prescriptions_attributes:[:dealer_id,:farmer_id,:crop_id,:condition,:crop_growth,:crop_cond,
