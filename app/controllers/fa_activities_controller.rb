class FaActivitiesController < ApplicationController
  ...
  def index
    @fa_activities = FaActivity.paginate(page: params[:page], per_page: 10)
  ...
  def input_user
    ...
    def fa_activity_params
      ...
      meet_farmers_attributes: [:id,:fa_activity_id, :farmer_id,:purpose,:dealer_id,:number_farmer,:consultation,:pocket_dat_id,:_destroy,
