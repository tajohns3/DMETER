class PocketsController < ApplicationController
  ...
  def new
    @pocket = Pocket.new
    9.times {@pocket.pocket_dats.build}
  ...
  private
    ...
    def pocket_params
      params.require(:pocket).permit(:state_id, :user_id, :pocket_name, :user_id, :district_id, :crop_id, :type_a, :type_b, :type_c, :type_d, :total_pdealer, :agriculture_land, :percent_irr, pocket_dats_attributes:[:id, :pocket_id, :pocket_info_id, :taluka, :village,  :_destroy],
                                      district_ids:[],
                                      crop_ids:[])
    end
end
